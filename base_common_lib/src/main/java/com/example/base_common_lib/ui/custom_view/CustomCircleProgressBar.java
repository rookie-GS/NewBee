...
public class CustomCircleProgressBar extends View {
    ...
    private String mText_content = "长按"; //动态更改中心内容
    private Paint paint;
    private String progressText;     //圆环内文字
    private Rect rect;
    private int round_time = 1500; //一圈的时间
    ...
    public CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideColor = a.getColor(R.styleable.CustomCircleProgressBar_outside_color, ContextCompat.getColor(getContext(), R.color.gold));
        ...
        insideCircleColor = a.getColor(R.styleable.CustomCircleProgressBar_inside_bg_color, ContextCompat.getColor(getContext(), R.color.gold));
        ...
        progressTextSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size, DimenUtil.dp2px(getContext(), 25.0f));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //第一步:画背景(即内层圆)
        paint.setColor(insideCircleColor); //设置圆的颜色
...
//        int pro_temp = getProgressText();
        progressText = getText_status();
    ...
    public void setRound_time(int time){
        round_time = time;
    }
    //中间的进度百分比
    ...
    //中间的进度百分比
    private String getText_status() {

        return mText_content;
    }
    ...
    /**开启*/
    public void start(){
        Iprogress_lisener.progress_start();
        setProgress(100);
        setText_status("松开取消");
    }
    public void finsh(){
        mText_content = "点击重置";
        Iprogress_lisener.progress_finsh();
    ...
    private void startAnim(float startProgress) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if(progress == 100){
                    ...
                    Iprogress_lisener.progress_going(getProgressint());
                }
                postInvalidate();
            }
        });
        ...
        if(startProgress == 0 ){
            ...
            animator.setDuration(round_time);
        }
        animator.setInterpolator(new LinearInterpolator());
        animator.start();
    }

    public interface IProgress_status_lisener{
        void progress_start();
        void progress_going(int progress);
        void progress_stop();
        void progress_finsh();
    }
    public void setIprogress_lisener(IProgress_status_lisener lisener){
        this.Iprogress_lisener = lisener;
    }
}
