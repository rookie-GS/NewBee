 ...
 * @Author G_JS
 *
 * @Date Created by 2020/6/12 11:25
 *
 */
...
public class ToastUtils {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(Other_Utils.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(Other_Utils.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(Other_Utils.getContext(), text, duration);
        } else {
//            sToast.setText(text);
            sToast.setDuration(duration);
        }

        sToast.setView(getShowView(text));
        sToast.show();
    }

//    public static void showToast2(CharSequence text) {
//        Toast toast = Toast.makeText(Utils.getContext(), text, Toast.LENGTH_LONG);
//        toast.setGravity(Gravity.CENTER, 0,0);
//        toast.setView(getShowView(text));
//        toast.show();
//    }

    private static View getShowView(CharSequence text){
        TextView textView = new TextView(Other_Utils.getContext());
